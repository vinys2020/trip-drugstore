...
import usecig from "../hooks/useProductoscig";
...
const HorizontalCarousel = () => {
    ...
    const { productos, loading } = usecig();
    ...
    const handleProductoClick = (producto) => {
        navigate(`/categorias/Cigarrillosid/producto/${producto.id}`, { state: { producto } });
    };
                ...
                {productos.map((producto, index) => (
                    ...
                    >
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.stopPropagation();
                                agregarAlCarrito(producto, "Cigarrillosid"); // PASO LA CATEGORÍA EXPLÍCITA
                            }}
                        >
                            Agregar al carrito
                        </button>
